...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        public void TestThatUserDoesRemoveFlightFromServiceLocatorWhenBooked()
        {
            ...
            var flightToBook = new Flight(new DateTime(2012, 3, 14), new DateTime(2012, 3, 15), 200);
            var remainingFlight = new Flight(new DateTime(2012, 3, 10), new DateTime(2012, 3, 11), 300);
